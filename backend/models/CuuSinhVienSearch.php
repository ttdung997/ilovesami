...
use backend\models\CuuSinhVien;

/**
 * CuuSinhVienSearch represents the model behind the search form about `backend\models\CuuSinhVien`.
 */
class CuuSinhVienSearch extends CuuSinhVien
{
    /**
     * @inheritdoc
     */
