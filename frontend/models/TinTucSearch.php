...
/**
 * TinTucSearch represents the model behind the search form about `frontend\models\TinTuc`.
 */
class TinTucSearch extends TinTuc
{
    ...
    {
        return [
            [['id', 'tac_gia_id'], 'integer'],
            [['tieu_de', 'anh_minh_hoa', 'gioi_thieu', 'phan_1', 'noi_dung_1', 'phan_2', 'noi_dung_2', 'phan_3', 'noi_dung_3', 'phan_4', 'noi_dung_4', 'ngay_lap'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'tieu_de', $this->tieu_de])
            ...
            ->andFilterWhere(['like', 'phan_4', $this->phan_4])
            ->andFilterWhere(['like', 'noi_dung_4', $this->noi_dung_4]);
